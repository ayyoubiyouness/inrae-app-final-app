...
periods_scenB10 <- periods_scenB2
...
output_consum_scenB10 <- read_consumed()


grain_ingest_par_fememlle_scenB10  <- output_consum_scenB10[[1]]
forage_ingest_par_fememlle_scenB10  <- output_consum_scenB10[[2]]
light_young_scenB10  <- output_consum_scenB10[[3]]
heavy_young_scenB10  <- output_consum_scenB10[[4]]
female_culled_scenB10  <- output_consum_scenB10[[5]]
...
plot_man_scenB10 <- data.frame(Surface = v, taille = taille)
plot_man_scenB10$taille[1] <- sum(filter(a, id_mod_expl_comp == "grassland")$taille)
plot_man_scenB10$taille[2] <- sum(filter(a, id_mod_expl_comp == "mowing")$taille)
plot_man_scenB10$taille[3] <- sum(filter(a, id_mod_expl_comp == "mowing/grassland")$taille)
plot_man_scenB10$taille[4] <- sum(filter(a, id_mod_expl_comp == "rangeland")$taille)
