...
periods_scen4 <- read_grazing_periods(x)
...
taux_paturage_scen4  <- output_taux[[1]]
auto_four_scen4  <- output_taux[[2]]
auto_concen_scen4  <- output_taux[[3]]
...
plot_man_scen4 <- as.data.frame(by(a$taille, list(a$id_mod_expl_comp), sum))
plot_man_scen4 <- cbind(rownames(plot_man_scen4), plot_man_scen4)
colnames(plot_man_scen4 ) <- c("Surface", "taille")
