...
periods_scenC5 <- read_grazing_periods(x, y = "grazing_periods.xlsx")
...
plot_man_scenC5 <- data.frame(Surface = v, taille = taille)
plot_man_scenC5$taille[1] <- sum(filter(a, id_mod_expl_comp == "grassland")$taille)
plot_man_scenC5$taille[2] <- sum(filter(a, id_mod_expl_comp == "mowing")$taille)
plot_man_scenC5$taille[3] <- sum(filter(a, id_mod_expl_comp == "mowing/grassland")$taille)
plot_man_scenC5$taille[4] <- sum(filter(a, id_mod_expl_comp == "rangeland")$taille)
